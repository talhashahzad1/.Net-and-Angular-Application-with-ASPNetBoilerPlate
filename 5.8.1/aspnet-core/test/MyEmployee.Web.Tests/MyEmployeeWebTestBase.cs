...
{
    public abstract class MyEmployeeWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MyEmployeeWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MyEmployeeWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MyEmployeeDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MyEmployeeDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MyEmployeeDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MyEmployeeDbContext, Task<T>> func)
        {
            T result;
